                                   ...
                                   <div>
                                       <div className="detaills_">
                                           ...
                                           <div className="description">
                                               ...
                                               <center>
                                                   <a target={"_blank"} rel="noreferrer" href={list.attributes.Portfolio_Link}>View Portfolio</a> <br />
           ...
           <div className="filt">
               ...
               <div className="filter2_">
                   ...
                   <form className="filter3_" method="get">
                       ...
                       <select defaultValue={"Requirement"} onChange={(event) => setjobExpreience(event.target.value)} className="select">
